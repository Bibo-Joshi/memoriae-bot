...
html_theme_options = {
    'style_nav_header_background': '#222426',
}
...
# of the sidebar.
html_logo = '../../logo/memoriae-bot-no-background.png'

# The name of an image file (relative to this directory) to use as a favicon of
# the docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = '../../logo/memoriae-bot-icon.ico'
