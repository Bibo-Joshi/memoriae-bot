...
1. Fork the ``memoriae-bot`` repository to your GitLab account.

2. Clone your forked repository of ``memoriae-bot`` to your computer:

   .. code-block:: bash

      $ git clone https://gitlab.com/<your username>/memoriae-bot --recursive
      $ cd memoriae-bot
...
3. Add a track to the original repository:
   ...
   .. code-block:: bash
      ...
      $ git remote add upstream https://gitlab.com/memoriae-bot/memoriae-bot
...
5. **Address review comments until all reviewers give LGTM ('looks good to me').**
   ...
   - Resolve any merge conflicts that arise. To resolve conflicts between 'your-branch-name' (in your fork) and 'master' (in the ``memoriae-bot`` repository), run:
...
7. **Celebrate.** Congratulations, you have contributed to ``memoriae-bot``!
...
.. _`issue tracker`: https://gitlab.com/HirschHeissIch/memoriae-bot/-/issues
.. _`developer' mailing list`: memoriae-bot@mahlerhome.de
